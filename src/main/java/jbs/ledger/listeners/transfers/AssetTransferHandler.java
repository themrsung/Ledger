package jbs.ledger.listeners.transfers;
...
public final class AssetTransferHandler extends LedgerListener {
    ...
    public void onCashOptionTransferred(CashOptionTransferredEvent e) {
        Economic s = e.getSender();
        Economic r = e.getRecipient();
        Option<Cash> a = e.getAsset();

        onCashOptionTransfer(s, r, a);
    }
    ...
    public void onStockOptionTransferred(StockOptionTransferredEvent e) {
        Economic s = e.getSender();
        Economic r = e.getRecipient();
        Option<Stock> a = e.getAsset();

        onStockOptionTransfer(s, r, a);
    }

    private static void onCashOptionTransfer(Economic s, Economic r, Option<Cash> a) {
        s.getCashOptions().remove(a);
        r.getCashOptions().add(a);
    }

    private static void onStockOptionTransfer(Economic s, Economic r, Option<Stock> a) {
